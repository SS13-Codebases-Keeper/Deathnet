...
#define ui_entire_screen "WEST,SOUTH to EAST,NORTH"
	...
	mymob.healths.icon = 'icons/mob/uihealth.dmi'
	...
	mymob.restin.icon_state = "act_rest"
	mymob.restin.name = "rest"
	mymob.restin.screen_loc = ui_rest
	if (mymob.resting)
		mymob.restin.icon_state = "act_rest1"
	else
		mymob.restin.icon_state = "act_rest0"
	src.hotkeybuttons += mymob.restin

	mymob.sleepin = new /obj/screen( null )
	mymob.sleepin.icon = ui_style
	mymob.sleepin.icon_state = "act_sleep"
	mymob.sleepin.name = "sleep"
	mymob.sleepin.screen_loc = ui_sleep
	if (mymob.sleeping)
		mymob.sleepin.icon_state = "act_sleep1"
	else
		mymob.sleepin.icon_state = "act_sleep0"
