...
/obj/screen/elementtop
	name = "deathnet"
	
/obj/screen/elementtop/Click()
	return

/obj/screen/elementbot
	name = "deathnet"
	
/obj/screen/elementbot/Click()
	return
	
/obj/screen/element1
	name = "deathnet"
	
/obj/screen/element1/Click()
	return
	
/obj/screen/element2
	name = "deathnet"
	
/obj/screen/element2/Click()
	return
	
/obj/screen/element3
	name = "deathnet"

/obj/screen/element3/Click()
	return
		...
		if(21 to 35) //Hands and groin
			switch(icon_x)
				...
				if(25 to 30)
					...
					return 1
		if(36 to 52) //Chest and arms to shoulders
			switch(icon_x)
				if(7 to 11)
					selecting = "r_arm"
				if(13 to 21)
				...
				if(22 to 25)
					...
					return 1
		if(53 to 64) //Head, but we need to check for eye or mouth
			if(icon_x in 14 to 20)
				selecting = "head"
				switch(icon_y)
					if(53 to 57)
						if(icon_x in 15 to 18)
							selecting = "mouth"
					if(58 to 62) //Eyeline, eyes are on 15 and 17
						if(icon_x in 14 to 16)
							selecting = "eyes"
					if(25 to 27)
						if(icon_x in 17 to 20)
							selecting = "eyes"
