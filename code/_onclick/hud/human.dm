...
*/
	...
	mymob.sleepin.icon_state = "sleep0"
	...
	mymob.hovertext = new /obj/screen/text/atm
	mymob.hovertext.maptext = ""
	mymob.hovertext.maptext_height = 100
	mymob.hovertext.maptext_width = 480
	mymob.hovertext.screen_loc = "CENTER-7, CENTER+7"
	src.adding += mymob.hovertext
...
*/
	...
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.healths, mymob.nutrition_icon, mymob.pullin, mymob.blind, mymob.flash, mymob.damageoverlay, mymob.rest, mymob.pain) //, mymob.hands, mymob.rest, mymob.sleepin) //, mymob.mach )
