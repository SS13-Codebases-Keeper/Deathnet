...
/*
	Middle click
	They really used MMB to swap hands and nothing else in 2012 baystation holy fuck
*/

/mob/proc/MiddleClickOn(var/atom/A)
	A.MiddleClick(src)
	return
/atom/proc/MiddleClick(var/mob/user)
	return
...
/atom/proc/ShiftClick(var/mob/user)
	if(user.client && user.client.eye == user)
		examine()
		for(var/mob/person in view(5, user))
			person.show_message("<small>[user] looks at [src].</small>")
		//user.face_atom(src)
	return
