#define NITROGEN_SLOWDOWN_FACTOR 4	//Higher == N2 slows reaction more
...
/obj/machinery/engine/supermatter/process()
	...
	var/oxygen = max(min((removed.gas["oxygen"] - (removed.gas["nitrogen"] * NITROGEN_SLOWDOWN_FACTOR)) / MOLES_CELLSTANDARD, 1), 0)
