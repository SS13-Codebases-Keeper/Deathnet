...
//Uncomment if you want maybe slightly smoother lighting - DON'T IT BREAKS THE LIGHTING
#define ul_Steps 7
...
atom/proc/SetLuminosity(var/Red, var/Green, var/Blue)
...
atom/proc/AddLuminosity(var/Red, var/Green, var/Blue)
