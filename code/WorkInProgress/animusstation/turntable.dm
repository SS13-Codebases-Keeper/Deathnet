...
/obj/machinery/party/turntable/attack_hand(mob/living/user as mob)
	...
	var/t = "<body background='turntable_back.jpg'><br><br><br><div align='center'><table border='0'><B><font color='maroon' size='6'>THE</font>  <font size='5' color='purple'>RAVE</font> <font size='5' color='green'>ON</font></B><br><br><br><br>"
	...
	for(var/datum/turntable_soundtrack/D in turntable_soundtracks)
		t += "<td height='50' weight='50'><A href='?src=\ref[src];on=\ref[D]'><font color='maroon'>[D.f_name]</font><font color='[lastcolor]'>[D.name] by [D.artist]</font></A></td>"
		i++
		if(i == 1)
