...
/turf/simulated/floor/open/proc/getbelow()
	...
	for(var/obj/effect/landmark/zcontroller/controller in controllerlocation)
		...
		if(istype(floorbelow, /turf/space))
			...
			return 0
		if(istype(floorbelow, /turf/simulated/wall) || istype(floorbelow, /turf/unsimulated))
			src.ChangeTurf(/turf/simulated/floor/plating)
			return 0
		if(istype(floorbelow, /turf/simulated/mineral))
			src.ChangeTurf(/turf/simulated/floor/grass/dirt)
			return 0
