...
/obj/item/weapon/storage/backpack/dark
	name = "backpack"
	desc = "A big bag for carrying all your problems."
	icon_state = "darkbackpack"
	item_state = "darkbackpack"
...
/obj/item/weapon/storage/backpack/darksatchel
	name = "satchel"
	desc = "A small bag for carrying all your problems."
	icon_state = "darksatchel"
	item_state = "satchel"