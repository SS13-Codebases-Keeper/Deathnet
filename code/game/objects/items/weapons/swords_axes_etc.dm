...
/obj/item/weapon/melee/colbaton
	name = "collapsible baton"
	desc = "A compact yet robust personal defense weapon. Very hurting nonetheless."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "colbaton_0"
	item_state = "colbaton_0"
	flags = FPRINT | TABLEPASS
	slot_flags = SLOT_BELT
	w_class = 2
	force = 15
...
/obj/item/weapon/melee/colbaton/attack_self(mob/user as mob)
	on = !on
	if(on)
		user.visible_message("\red With a flick of their wrist, [user] extends their collapsible baton.",\
		"\red You extend the baton.",\
		"You hear an ominous click.")
		icon_state = "colbaton_1"
		item_state = "colbaton_1"
		w_class = 3
		force = 25//quite robust
		attack_verb = list("smacked", "struck", "slapped")
	else
		user.visible_message("\blue [user] collapses their collapsible baton.",\
		"\blue You collapse the baton.",\
		"You hear a click.")
		icon_state = "colbaton_0"
		item_state = "colbaton_0"
		w_class = 2
		force = 15 //still a hunka shit
		attack_verb = list("decked", "clocked")
