...
/turf/simulated/floor/wood/frame
	name = "floor"
	icon_state = "woodframe"
	floor_tile = new/obj/item/stack/tile/wood/frame

/turf/simulated/floor/wood/birch
	name = "floor"
	icon_state = "birch"
	floor_tile = new/obj/item/stack/tile/birch

/turf/simulated/floor/wood/birchframe
	name = "floor"
	icon_state = "birchframe"
	floor_tile = new/obj/item/stack/tile/birch/frame

/turf/simulated/floor/wood/roughwood
	name = "floor"
	icon_state = "roughwood"
	floor_tile = new/obj/item/stack/tile/roughwood

/turf/simulated/floor/wood/oldwood
	name = "floor"
	icon_state = "oldwood"
	floor_tile = new/obj/item/stack/tile/oldwood
...
/turf/simulated/floor/grass/muddy
	name = "grass patch"
	icon_state = "dirtygrass1"
	floor_tile = new/obj/item/stack/tile/grass

	New()
		floor_tile.New() //I guess New() isn't ran on objects spawned without the definition of a turf to house them, ah well.
		icon_state = "dirtygrass[pick("1","2","3")]"
		..()
		spawn(4)
			if(src)
				update_icon()
...
/turf/simulated/floor/grass/dirt
	name = "dirt"
	icon_state = "dirt"
	floor_tile = new/obj/item/stack/tile/grass

/turf/simulated/floor/grass/mud
	name = "mud"
	icon_state = "mud"
	floor_tile = new/obj/item/stack/tile/grass
