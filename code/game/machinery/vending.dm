...
/obj/machinery/vending/sustenance
	...
	products = list(/obj/item/weapon/reagent_containers/food/snacks/nutribar = 10,
					/obj/item/weapon/reagent_containers/food/snacks/nugget = 5,
					/obj/item/weapon/reagent_containers/food/snacks/nugget2 = 5)


/obj/machinery/vending/pepsi
	name = "\improper Drink Vendor"
	desc = "A vending machine which vends drinks."
	product_slogans = "Enjoy your drink."
	product_ads = "Sufficiently healthy."
	icon_state = "pepsi"
	products = list(/obj/item/weapon/reagent_containers/food/drinks/cans/cola = 10, /obj/item/weapon/reagent_containers/food/drinks/cans/grape_juice = 10)