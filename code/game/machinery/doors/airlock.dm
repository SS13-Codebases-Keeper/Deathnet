...
/obj/machinery/door/airlock/rust_door
	name = "Rusted Airlock"
	icon = 'icons/obj/doors/rust_door.dmi'

/obj/machinery/door/airlock/sleek_door
	name = "Sleek Metal Airlock"
	icon = 'icons/obj/doors/sleek_door.dmi'

/obj/machinery/door/airlock/joe_door
	name = "Compressor Airlock"
	icon = 'icons/obj/doors/joe_door.dmi'
