...
/obj/item/weapon/newspaper
	name = "newscast brochure"
	desc = "A paper listing the headlines for the folks who are somehow not exposed to them yet through different chanenls. This one is all fucked up."
...
obj/item/weapon/newspaper/attack_self(mob/user as mob)
		user << "\red It's all smudged up. What a piece of shit."
		return
