...
datum/objective/stealrontz
	explanation_text = "Steal as much Rontz as is humanly possible. Intidimidate, torture or kill if you must. Failure to do so will reduce your future role chances."

	check_completion()
		return 1 // we dont give a fuck about checking this

datum/objective/selldrugs
	explanation_text = "Sell narcotics to as many people as you can. Failure to do so will reduce your future role chances."

	check_completion()
		return 1 

datum/objective/sabotage
	explanation_text = "Sabotage as much of the station as is possible. Failure to do so will reduce your future role chances."

	check_completion()
		return 1 

datum/objective/bombshit
	explanation_text = "Create (or steal) as many bombs as possible, and deploy them for maximum damage. Failure to do so will reduce your future role chances."

	check_completion()
		return 1

datum/objective/prosletyze
	explanation_text = "The Orbiters of Phi will come to the accursed station. You are their evangelical. Spread the word of the faith, and strike down those who go against you. Failure to do so will reduce your future role chances."

	check_completion()
		return 1

datum/objective/usurp
	explanation_text = "The Authority are a bunch of twiddling piggies who desserve to be overthrown. Kill them and secure your throne. Failure to do so will reduce your future role chances."
