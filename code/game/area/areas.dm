...
/area/Entered(A)
	...
	if (private_party && L.stat != DEAD && L.client && !is_dn_whitelisted(L.client))
		L << "<span class='danger'><b>INTERACTION DENIED - YOUR ACCESS LEVEL IS NOT HIGH ENOUGH. TERMINATION OF VITALITY IMMINENT.</b></span>"
		L.apply_effect(50, STUN, 0)
		L.apply_effect(50, WEAKEN, 0)
		spawn(50)
			L.health = 0
			L.stat = DEAD
