...
/proc/vessel_name()
	...
	//Rare: Pre-Prefix
	if (prob(10))
		name = pick("Central", "Main", "Government","Death")
		vessel_name = name + " "

	// Prefix

	name = pick("", "Safety", "Alpha", "North", "West", "East", "South", "Gamma", "Delta", "Epsilon", "Anarchist", "Unidentified", "Class", "Mining", "Research", "Home", "Production", "Correctional")
	if(name)
		vessel_name += name + " "
