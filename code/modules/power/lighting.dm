...
/obj/machinery/light/small
	...
	var/flicker_probability = 0.05 //adjust this if it gives the rubes epilepsies
	var/flicker_time = 10 SECONDS //adjust for specific bulbs that need to be constantly flickering
