...
/client/verb/adminhelp(msg as text)
	set category = "Would You Like to Know More"
	set name = "Truth of Query"

	//handle muting and automuting
	if(prefs.muted & MUTE_ADMINHELP)
		src << "<font color='red'>Error: WYLKM-TOQ: You've been silenced. L-O-L.</font>"
		return
...
*/
	...
	src << "<font color='blue'><b>Your pleas have been directed to the Superstition of Malice.</font>"
	/*src << "<font color='blue'>PM to-<b>Superstitions</b>: [original_msg]</font>"*/
