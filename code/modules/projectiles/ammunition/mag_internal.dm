...
/obj/item/ammo_magazine/internal/sludge
	name = "sludgegun waste"
	desc = "And that was it, folks."
	ammo_type = /obj/item/ammo_casing/sludge
	caliber = ".50"
	max_ammo = 1

/obj/item/ammo_magazine/internal/cylinder/echo
	name = "echo revolver internal magazine"
	ammo_type = /obj/item/ammo_casing/a8mag
	caliber = "8mag"
	max_ammo = 6
	cylinders = 6

/obj/item/ammo_magazine/internal/shot/broom
	name = "broom shotgun internal magazine"
	ammo_type = /obj/item/ammo_casing/shotgun/a10ga
	caliber = ".12"
	max_ammo = 4