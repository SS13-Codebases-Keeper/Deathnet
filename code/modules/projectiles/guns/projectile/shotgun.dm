...
/obj/item/weapon/gun/projectile/shotgun/broom
	name = "Core City Arsenal S-4 'Broom' Stakeout Gun"
	desc = "A brutally effective way to depopulate a slum. Chambers 10ga shells."
	mag_type = /obj/item/ammo_magazine/internal/shot/broom
	icon_state = "broom"
	item_state = "shotgun"