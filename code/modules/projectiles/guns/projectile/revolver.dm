...
/obj/item/weapon/gun/projectile/revolver/echo
	name = "\improper Harkonnen R-8 'Echo' Officer Carry"
	desc = "A revolver issued to high-ranking Authoritarians who tend to use guns more for frontline executions than actual combat. Chambers 8mm Magnum cartridges."
	icon_state = "echo"
	item_state = "revolver"
	mag_type = /obj/item/ammo_magazine/internal/cylinder/echo
