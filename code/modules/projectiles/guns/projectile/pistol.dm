...
/obj/item/weapon/gun/projectile/revolver/doublebarrel/improvised/sludgegun
	name = "\improper Deck-setter Sludgegun"
	desc = "A goo-ey mass of flesh, lubricants and industrial chemicals. It molds warmly around your hand."
	icon_state = "sludgegun"
	w_class = 2.0
	mag_type = /obj/item/ammo_magazine/internal/sludge
	fire_sound = 'sound/weapons/flesh.ogg'
	force = 10

/obj/item/weapon/gun/projectile/automatic/pistol/encgimel
	name = "\improper Enc-Gimel m. 2382"
	desc = "An old Pioneer's carbine with the stock and grip furnitures lost to time. Chambers the outdated .455 Heavy cartridges."
	icon_state = "encgimel"
	item_state = "pistol"
	w_class = 2.0
	mag_type = /obj/item/ammo_magazine/external/encgimel

/obj/item/weapon/gun/projectile/automatic/pistol/resonator
	name = "\improper Schmidt-Sakai SC16 'Resonator' Export Model"
	desc = "A small pistol found in the hands of many governmental reformed-thugs. Chambers 8mm Compact."
	icon_state = "resonator"
	item_state = "pistol"
	w_class = 2.0
	mag_type = /obj/item/ammo_magazine/external/resonator

/obj/item/weapon/gun/projectile/automatic/resonator/afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, flag)
	..()
	if(!chambered && !get_ammo() && !alarmed)
		playsound(user, 'sound/weapons/smg_empty_alarm.ogg', 40, 1)
		update_icon()
