...
/mob/new_player
	...
	proc/new_player_panel_proc()
		var/output = "<div align='center'><img src='https://cdn.discordapp.com/attachments/1086025846785069056/1119378958362882184/9133487178542b1e6b0e90eec53ddb1b.png'>"
		output += "<p><a href='byond://?src=\ref[src];show_preferences=1'><img src='https://cdn.discordapp.com/attachments/1086025846785069056/1119365316473004043/visage.png'></A></p>"

		if(!ticker || ticker.current_state <= GAME_STATE_PREGAME)
			if(!ready)	output += "<p><a href='byond://?src=\ref[src];ready=1'><img src='https://media.discordapp.net/attachments/1086025846785069056/1119365315617374318/makeamends.png'></A></p>"
			else	output += "<p><a href='byond://?src=\ref[src];ready=2'><img src='https://media.discordapp.net/attachments/1086025846785069056/1119365316217159810/makeamendsred.png'></A></p>"

		else
			//output += "<a href='byond://?src=\ref[src];manifest=1'>View the Crew Manifest</A><br><br>"
			output += "<p><a href='byond://?src=\ref[src];late_join=1'><img src='https://media.discordapp.net/attachments/1086025846785069056/1119365315919347732/append.png'></A></p>"

		/*output += "<p><a href='byond://?src=\ref[src];observe=1'>Observe</A></p>"
		output += "</div>"*/

		//src << browse(output,"window=playersetup;size=210x240;can_close=0")
		var/datum/browser/popup = new(src, "playersetup", "", 300, 300)
		popup.set_content(output)
		popup.set_window_options("can_close=0;titlebar=0;")
		popup.open()
		return
		...
		if(client.statpanel=="Lobby" && ticker)
			if(ticker.hide_mode)
				...
				if(ticker.hide_mode == 0)
					stat("Game Mode:", "Eternity") //, "[master_mode]") 
	...
	Topic(href, href_list[])
		if(!client)	return 0
		var/sound/Shit = sound("sound/deathnet/menu/beep[rand(1,6)].ogg", repeat = 0, wait = 0, volume = 50, channel = 0)
		Shit.frequency = get_rand_frequency()
		src << Shit
		...
		if(href_list["observe"])
			src << "Nice try, smart-ass."
			/*if(alert(src,"Are you sure you wish to observe? You will have to wait 30 minutes before being able to respawn!","Return","Yes","No") == "Yes")
				if(!client)	return 1
	...
	proc/AttemptLateSpawn(rank)
		...
		if(character.mind.assigned_role != "Cyborg")
			...
			//AnnounceArrival(character, rank) - Please don't.
