...
/datum/sprite_accessory/hair
	...
	bald
		...
		icon_state = "bald"
		gender = MALE
		species_allowed = list("Human","Unathi", "Sinner")
...
/datum/sprite_accessory/facial_hair
	...
	shaved
		...
		icon_state = "bald"
		gender = NEUTER
		species_allowed = list("Human","Unathi","Tajaran","Skrell","Vox","Machine", "Sinner")
...
/datum/sprite_accessory/skin
	...
	skrell
		name = "Default sinner skin"
		icon_state = "default"
		icon = 'icons/mob/human_races/r_sinner.dmi'
		species_allowed = list("Sinner")