...
/datum/language/sinner
	name = "Forbidden Tongue"
	desc = "All of your sins are made clear before you. Are you proud?"
	speech_verb = "wails"
	ask_verb = "wails"
	exclaim_verb = "wails"
	colour = "sinner"
...
/datum/language/common //GALCOM, GALACTIC COMMON, ENGLISH, DEATHNET LANGUAGE
	name = "Neurolinguistic English"
	desc = "NLE is a highly fragmented and condensed form of English, designed to cater to the fast-paced and chaotic nature of the City-Sector. It incorporates elements of slang, jargon, and technical terminology, merging them into a distinct linguistic code."
	speech_verb = "says"
	key = "0"
	flags = RESTRICTED
