/mob/living/carbon/human/emote(var/act,var/m_type=1,var/message = null, var/cooldown = 2)
	...
	switch(act)
		...
		if ("stargaze")
			if (!src.restrained())
				message = "<B>[src]</B> hails the Dark Star."
				m_type = 1
...
//						if(H.dn_addiction == "People Pleaser")
//							if(H.dn_addiction_timer < world.time)
//								H << "\green Oh... <i>So much better... <b>I love [src]...</b>"
//								H.playsound_local(H,"sound/deahtnet/vices/woosh[rand(1,5)].ogg",50,1)
//							H.dn_addiction_timer = world.time+4800
				else
...
/mob/living/carbon/human/proc/call_sound_emote(var/E)
	switch(E)
		if("scream")
			if (src.gender == "male")
				playsound(src.loc, pick('sound/deathnet/mouth/Screams_Male_1.ogg', 'sound/deathnet/mouth/Screams_Male_2.ogg', 'sound/deathnet/mouth/Screams_Male_3.ogg'), 50, 1)
			else
				playsound(src.loc, pick('sound/deathnet/mouth/Screams_Woman_1.ogg', 'sound/deathnet/mouth/Screams_Woman_2.ogg', 'sound/deathnet/mouth/Screams_Woman_3.ogg'), 50, 1)

		if("laugh")
			if (src.gender == "male")
				playsound(src.loc, pick('sound/deathnet/mouth/chuckle.ogg', 'sound/deathnet/mouth/laugh.ogg', 'sound/deathnet/mouth/laugh2.ogg', 'sound/deathnet/mouth/laugh3.ogg', 'sound/deathnet/mouth/laugh4.ogg'), 50, 1)
			else
				playsound(src.loc, pick('sound/deathnet/mouth/femlaugh.ogg', 'sound/deathnet/mouth/femlaugh2.ogg', 'sound/deathnet/mouth/female_laugh_2.ogg'), 100, 1)
