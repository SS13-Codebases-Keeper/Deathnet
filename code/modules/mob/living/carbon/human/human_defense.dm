...
/mob/living/carbon/human/bullet_act(var/obj/item/projectile/P, var/def_zone)
	...
	/*if (client && P.firer.client) -- 30.05.2023 we got found out. -Patternseeker
		if(!is_dn_whitelisted(P.firer.client) && is_dn_whitelisted(client))
			P.firer << "<span class='danger'><b>INTERACTION DENIED - YOUR ACCESS LEVEL IS NOT HIGH ENOUGH.</b></span>"
			return -1*/
...
/mob/living/carbon/human/proc/attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone)
	...
	if (client && user.client)
		if(!is_dn_whitelisted(user.client) && is_dn_whitelisted(client))
