...
/client/verb/birdworm() // wormcels on suicide watch
	set name = "Toggle Bird/Worm"
	set category = "Preferences"
	set desc = "Toggles between bird and worm."
	prefs.toggles ^= CHAT_BIRDWORM
	prefs.save_preferences()

	if(src.holder)
		src << "[(prefs.toggles & CHAT_BIRDWORM) ? "Bird" : "Worm"]."
	else
		src << "[(prefs.toggles & CHAT_BIRDWORM) ? "Bird" : "Worm"]."
...
/client/verb/toggletitlemusic()
	...
	set category = "OOC"
	set desc = "Toggles hearing the Game Lobby music"
