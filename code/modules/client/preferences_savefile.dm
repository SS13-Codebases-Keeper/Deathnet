...
/datum/preferences/proc/load_character(slot)
	...
	S["job_auth_high"]		>> job_auth_high
	S["job_auth_med"]		>> job_auth_med
	S["job_auth_low"]		>> job_auth_low
	S["job_citizen_high"]	>> job_citizen_high
	S["job_citizen_med"]	>> job_citizen_med
	S["job_citizen_low"]	>> job_citizen_low
	...
	job_auth_high = sanitize_integer(job_auth_high, 0, 65535, initial(job_auth_high))
	job_auth_med = sanitize_integer(job_auth_med, 0, 65535, initial(job_auth_med))
	job_auth_low = sanitize_integer(job_auth_low, 0, 65535, initial(job_auth_low))
	job_citizen_high = sanitize_integer(job_citizen_high, 0, 65535, initial(job_citizen_high))
	job_citizen_med = sanitize_integer(job_citizen_med, 0, 65535, initial(job_citizen_med))
	job_citizen_low = sanitize_integer(job_citizen_low, 0, 65535, initial(job_citizen_low))
