...
/obj/item/weapon/reagent_containers/food/snacks/nutribar //stop using these in the map as a ctual food, this is WORM SHIT
	name = "condensed goo"
	desc = "A viscous brick of goo."
	icon_state = "sludge"
	trash = null
	filling_color = "#18181f"
	New()
		..()
		reagents.add_reagent("nutriment", 3)
		bitesize = 3
...
/obj/item/weapon/reagent_containers/food/snacks/nugget2
	name = "flesh nugget"
	desc = "Delicious and tasty."
	icon_state = "nugget2"
	trash = null
