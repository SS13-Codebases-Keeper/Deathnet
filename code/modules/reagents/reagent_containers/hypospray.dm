...
/obj/item/weapon/reagent_containers/hypospray/medipen/synaptica
	name = "synaptica injector"
	desc = "One a day keeps the Sun away."
	icon_state = "synaptica"
	item_state = "autoinjector"
	volume = 5
	list_reagents = list("salglu_solution" = 5)

/obj/item/weapon/reagent_containers/hypospray/medipen/synaptica/poisoned //we do a little bit of trolling
	name = "synaptica injector"
	desc = "One a day keeps the Sun away."
	icon_state = "synaptica"
	item_state = "autoinjector"
