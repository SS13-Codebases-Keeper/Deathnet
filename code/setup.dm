...
#define MAX_HIGH_PRESSURE_DAMAGE 12	//This used to be 20... I got this much random rage for some ed decision by polymorph?! Polymorph now lies in a pool of blood with a katana jammed in his spleen. ~Errorage --PS: The katana did less than 20 damage to him :(
...
#define MASKCOVERSEYES		1024		// get rid of some of the other ation in these flags
...
#define CHAT_BIRDWORM 16384

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|CHAT_OOC|CHAT_PRAYER|CHAT_ATTACKLOGS)
...
#define IS_PLANT 512 //1024
#define IS_WHITELISTED 1024 //2048
#define IS_SYNTHETIC 2048 //4096
